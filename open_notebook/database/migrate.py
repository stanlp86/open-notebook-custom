...
class MigrationManager:
    def __init__(self):
        self.connection = SurrealSyncConnection(
            ...
            encrypted=os.environ["ENCRYPTED_CONNECTION"],  # Set to True if using SSL
        )
        self.up_migrations = [
        ...
        self.down_migrations = [
            ...
            Migration.from_file("migrations/4_down.surrealql"),                Migration.from_file("migrations/5_down.surrealql"),
        ]
